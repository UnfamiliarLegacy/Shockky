...
public ref struct ShockwaveWriterRaw : ShockwaveWriter
{
    ...
    public ShockwaveWriterRaw(Span<byte> data, bool reverseEndianness)
    {
        _data = data;
        _position = 0;
    ...
    {
        // TODO: Optimize
        int size = ShockwaveWriter.GetVarUIntSize(value);
        int pos = size - 1;
